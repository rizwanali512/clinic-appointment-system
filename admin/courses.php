        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="13%" >
                    <a href="?action=add-session&id=none&error=0"  ><button  class="login-btn btn-primary-soft btn  "  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:225px"><font class="tn-in-text">Upload  Course</font></button></a>
                    </td>
                    <td width="15%">
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <tr>
                                <th class="table-headin" width="40%">
                                    Document Title
                                </th>
                                <th class="table-headin" width="40%">
