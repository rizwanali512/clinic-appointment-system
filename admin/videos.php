                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">admin@dermadenclinic.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Media Content (Videos)</p>
                                           
                    </td>
                    <td width="13%" >
                    <a href="?action=add-session&id=none&error=0"  ><button  class="login-btn btn-primary-soft btn  "  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:225px"><font class="tn-in-text">Upload Video</font></button></a>
                    </td>
                    <td width="15%">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Contents (<?php echo $list110->num_rows; ?>)</p>
                    </td>
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <tr>
                                <th class="table-headin" width="25%">
                                    Name
                                </th>
                                <th class="table-headin" width="30%">
                                ...
                                <th class="table-headin" width="15%">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Add New Media Content.</p><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="submit" value="Upload " class="login-btn btn-primary btn" name="shedulesubmit">
                                </td>
