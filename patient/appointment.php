...
<body>
  ...
  //  $sqlmain= "select appointment.appoid,schedule.scheduleid,schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where  patient.pid=$userid ";
    $sqlmain = "select * from appointment  inner join patient on patient.pid=appointment.pid where  patient.pid=$userid";
    if($_POST){
        //print_r($_POST);
                ...
                <tr>
                    <td style="padding:10px" colspan="2">
                        <table border="0" class="profile-container">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a  href="?action=add-session&id=none&error=0"><input type="button" value="Book an Appointment" class="logout-btn btn-primary-soft btn"></a>
                                </td>
                            </tr>
                            <tr >
                                <td colspan="2">
                                    <a style="margin-top:20px;display:block" href="../logout.php" >Logout</a>
                                </td>
                            </tr>
                    </table>
                    </td>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="?action=add-session&id=none&error=0"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Book an Appointment &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                <form action="booking-complete.php" method="POST" class="add-new-form">
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="specid" class="form-label">Select Category: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="time" name="time" class="input-text" min="08:00" max="20:00" placeholder="Time" required><br>
                                </td>
                            </tr>
