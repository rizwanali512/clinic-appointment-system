                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle"><?php echo substr($useremail,0,32)  ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <a href="../logout.php" ><input type="button" value="Book an Appointment" class="logout-btn btn-primary-soft btn"></a>
                                </td>
                            </tr>
                            <tr >
                                <td colspan="2">
